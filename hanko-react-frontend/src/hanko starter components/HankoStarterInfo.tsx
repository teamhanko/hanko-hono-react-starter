...
const HankoStarterInfo = () => {
  return (
    <div className="starterInfo">
      <h1>Hanko React + Node  starter.</h1>
      <h2>
        This repository is an example of an implementation of <span>Hanko</span> with <span>React</span> as frontend and <span>Node</span> as backend.
      </h2>
      <h2>
